...
🚀 **I'm thrilled to announce the v0.1.0 release of Hybrid FinOps Command Center!**
...
🧠 **AI Optimization Copilot:** Powered by Gemini 2.5 Flash via Vercel Serverless Edge, generating structured 30/60/90-day execution plans.
📂 **CSV Intelligence Staging:** Client-side PapaParse integration to ingest millions of rows securely.
